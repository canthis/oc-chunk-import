<?php namespace CanThis\ImportExport\Behaviors;
...
use CanThis\ImportExport\Behaviors\ImportExportController\TranscodeFilter;
...
class ImportExportController extends ControllerBehavior
{
    ...
    protected function getImportTotalRows() {
        ...
        $totalRows = $reader->each(function() {
            return true;
        }); 
    ...
    protected function makeImportUploadFormWidget()
    {
        ...
        $widgetConfig = $this->makeConfig('~/plugins/canthis/importexport//behaviors/importexportcontroller/partials/fields_import.yaml');
    ...
    protected function makeExportFormatFormWidget()
    {
        ...
        $widgetConfig = $this->makeConfig('~/plugins/canthis/importexport//behaviors/importexportcontroller/partials/fields_export.yaml');
